...
export const useMyInterestStore = defineStore('skill', () => {
    /* state */
    const generalStore = useGeneralStore()

    const myAssetSelectOptions = ref([])
    ...
    function fetchMyAssetSelectContents() {

        generalStore.loading = true;
        myAssetSelectOptions.value = [];
        ...
        axios
            ...
            .then(response => {
                ...
                if (response.status == 200) {
                    // console.log(response);
                    myAssetSelectOptions.value = response.data.data;
                }
            })
            .catch(error => {
                error = error.toString();
    ...
    return {
        myAssetSelectOptions, fetchIndexContents, fetchMyAssetSelectContents, storeAsset, updateAsset, deleteAsset, showStoreForm,
    }
})
