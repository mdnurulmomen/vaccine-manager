...
export const usePoliticalPartyStore = defineStore('political-party', () => {
    /* state */
    ...
    function storeContent() {
        ...
        axios
            .post('api/v1/political-parties/', generalStore.currentEntity)
            .then(response => {
                if (response.status == 200) {
                    toast.success("New political-party has been created");
                    generalStore.currentIndexContents = response.data.data;
    ...
    function updateContent() {
        ...
        axios
            .put('api/v1/political-parties/' + generalStore.currentEntity.id, generalStore.currentEntity)
            .then(response => {
                if (response.status == 200) {
    ...
    function deleteContent() {
        ...
        axios
            .delete('api/v1/political-parties/' + generalStore.currentEntity.id)
            .then(response => {
                if (response.status == 200) {
