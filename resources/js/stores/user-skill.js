...
export const useUserSkillStore = defineStore('user-skill', () => {
    /* state */
    ...
    function storeContent() {
        ...
        axios
            .post('api/v1/user-skills/', generalStore.currentEntity)
            .then(response => {
                if (response.status == 200) {
    ...
    function updateContent() {
        ...
        axios
            .put('api/v1/user-skills/' + generalStore.currentEntity.id, generalStore.currentEntity)
            .then(response => {
                if (response.status == 200) {
    ...
    function deleteContent() {
        ...
        axios
            .delete('api/v1/user-skills/' + generalStore.currentEntity.id)
            .then(response => {
                if (response.status == 200) {
