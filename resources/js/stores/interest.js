...
export const useInterestStore = defineStore('interest', () => {
    ...
    function storeAsset() {
        ...
        axios
            .post('api/v1/interests/', generalStore.currentEntity)
            .then(response => {
                if (response.status == 200) {
    ...
    function updateAsset() {
        ...
        axios
            .put('api/v1/interests/' + generalStore.currentEntity.id, generalStore.currentEntity)
            .then(response => {
                if (response.status == 200) {
    ...
    function deleteAsset() {
        ...
        axios
            .delete('api/v1/interests/' + generalStore.currentEntity.id)
            .then(response => {
                if (response.status == 200) {
